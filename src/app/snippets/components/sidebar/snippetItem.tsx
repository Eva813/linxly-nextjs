...
const SnippetItem: React.FC<SnippetItemProps> = React.memo(({
  ...
  return (
    <li className="mb-2">
      <div
        className={`flex items-center justify-between px-2 py-1 w-full block rounded hover:bg-light dark:hover:text-black ${
          isActiveSnippet ? "bg-light dark:text-black" : "bg-transparent"
        }`}
      >
        <Link
          prefetch
