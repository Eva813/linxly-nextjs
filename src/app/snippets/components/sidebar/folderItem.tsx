...
const FolderItem: React.FC<FolderItemProps> = ({
  ...
  return (
    <li className="mb-2">
      ...
      <Link
        prefetch
        className={`px-2 py-1 w-full block rounded hover:bg-light dark:hover:text-black flex items-center justify-between text-lg ${
          isActiveFolder ? "bg-light dark:text-black" : ""
        }`}
